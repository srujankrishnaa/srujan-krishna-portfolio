  ...
  return (
    <section className="pb-3 pt-8 md:mt-8 md:pb-16 lg:mt-10">
      ...
      <div className="mt-16 space-y-6">
        ...
        <p className="text-lg text-zinc-600 dark:text-zinc-400">Curious about this site? It features:</p>
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <p className="mb-6 text-zinc-600 dark:text-zinc-400">
              For typography, Inter sets the stage with body text, Neue Montreal emphasizes
              special words, Lombok makes playground headings pop, and Catholic School Girls BB
              adds flair to Polaroid images. Each font is uniquely styled to highlight its role.
            </p>
            ...
            <div className="grid grid-cols-2 gap-0">
              ...
              <div className="flex items-center justify-center border border-dashed border-zinc-600 p-6 dark:border-zinc-400">
                <p className="text-center font-cath text-xl">Catholic School Girls BB</p>
              </div>
            </div>
          </div>
        </div>
